...
export default function Translation() {
	...
	// console.log(moment(orderBy(proj.history, [(h) => moment(h.date, "DD/MM/YYYY").toDate()], ["desc"])[0].date)
	const projects = orderBy(t('translation:projects'), [(proj) => moment(orderBy(proj.history, [(h) => { console.log(h); moment(h.date, "DD/MM/YYYY").toDate()}], ["desc"])[0].date, "DD/MM/YYYY").toDate()], ["desc"])
