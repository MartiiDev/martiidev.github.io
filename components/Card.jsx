...
export default function Card({ project, type = "trad", className = "", first = false, ...rest }) {
	...
	return (
		<>
			...
			{showImage && <button onClick={() => setShowImage(null)} className="fixed z-[99999] left-0 top-0 w-screen h-screen bg-black grid place-content-center" title={t('toggleimage')}><img src={"/images/" + type + "/" + showImage + ".jpg"} className="object-contain max-h-screen max-w-screen" /></button>}
